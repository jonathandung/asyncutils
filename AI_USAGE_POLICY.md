...
tools can feel like a safer and less judgemental first step. However, LLMs often provide incorrect or incomplete answers, and they may create a false
sense of understanding.

If you do end up using AI tools, we ask that you only do so in an **assistive** (like a reference or tutor) and not **generative** (having the tool
write code for you) manner.
