...
.. code-block:: bash
  ...
  pip install py-asyncutils==0.8.25
...
.. code-block:: bash
  ...
  pipx install py-asyncutils==0.8.25

or with conda:

.. code-block:: bash

  conda install -c conda-forge py-asyncutils=0.8.25
...
.. code-block:: bash
  ...
  conda install py-asyncutils==0.8.25

or with uv:

.. code-block:: bash

  uv pip install 'py-asyncutils==0.8.25'
