...
Also see :doc:`the standard library audit event table <python:library/audit_events>`, from which the inclusion and format of this table take
inspiration.
...
.. list-table:: Audit events
  ...
  * - asyncutils.futures.TimeAwareAsyncCallbacksFuture/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.TimeAwareAsyncCallbacksFuture`.
  * - asyncutils.futures.TimeAwareAsyncCallbacksTask/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.TimeAwareAsyncCallbacksTask`.
  * - asyncutils.futures.UniqueCallbacksFuture/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.UniqueCallbacksFuture`.
  * - asyncutils.futures.UniqueCallbacksTask/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.UniqueCallbacksTask`.
  * - asyncutils.futures.TimeAwareUniqueCallbacksFuture/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.TimeAwareUniqueCallbacksFuture`.
  * - asyncutils.futures.TimeAwareUniqueCallbacksTask/schedule_callbacks
    - ``addr``: :class:`int`
    - The above, but for exact instances of :class:`futures.TimeAwareUniqueCallbacksTask`.
