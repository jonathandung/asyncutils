...
def lockf[T, **P](f: Callable[P, Awaitable[T]], /, lf: type[AsyncLockLike]=...) -> Callable[P, Coroutine[Any, Any, T]]: '''Apply a lock to a function that returns an awaitable, converting it to an async function whose calls are locked by a lock generated by the factory `lf`.'''
