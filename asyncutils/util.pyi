...
from ._internal.prots import AsyncLockLike, NullContextType, DCRV, DualContextManager, EventProt, ExceptionWrapper, FutProt, IncompleteFut, SupportsIteration, ToSyncFromLoopRV, TransientBlockFromLoopRV
...
@overload
def done_evt[T: EventProt](*, evtcls: type[T]) -> T: ...
@overload
