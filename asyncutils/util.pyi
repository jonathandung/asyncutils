...
def to_async[T, **P](f: Callable[P, T], /, loop: AbstractEventLoop|None=...) -> tuple[Callable[P, Coroutine[Any, Any, T]], Callable[[], None]]: '''Return a tuple `(asyncf, shutdown)`. asyncf is the async version of the original function (runs in an executor) and shutdown is a function to shut down the executor.'''
