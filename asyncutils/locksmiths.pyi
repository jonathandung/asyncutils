...
class LocksmithBase:
    ...
    async def host[T](self, task: Awaitable[T], lock: AsyncLockLike[Any], /, *, timeout1: float|None=..., timeout2: float|None=..., timeout3: float|None=...) -> T: '''Run ``task`` holding ``lock`` immediately after forcing it. The default values of the timeouts are taken from :data:`context.LOCKSMITH_BASE_DEFAULT_TIMEOUTS`.'''
