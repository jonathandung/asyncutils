...
class Context:
    ...
    .. note:: Refer to :doc:`config` for the factory default values of each setting.
...
.. note::
  ...
  These names are not listed by calling :func:`dir` on this submodule, since there are so many of them (88 as of now!) and more may be added in the future,
...
EVENT_LOOP_BASE_FLAGS: Final[int]
...
EVENT_BUS_PUBLISH_DEFAULT_SAFE: Final[bool]
...
BENCHMARK_DEFAULT_SEQUENTIAL: Final[bool]
...
LOCKSMITH_BASE_DEFAULT_TIMEOUTS: Final[tuple[float|None, float|None, float|None]]
...
AGING_RWLOCK_DEFAULT_READ_PRIORITY_FACTOR: Final[float]
AGING_RWLOCK_DEFAULT_WRITE_PRIORITY_FACTOR: Final[float]
...
DUAL_CONTEXT_MANAGER_DEFAULT_STRICT: Final[bool]
