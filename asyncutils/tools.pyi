...
def get_cfg_json_format() -> str:
    ...
    | If you would like a format schema for other languages, a programmatic approach would likely be unnecessary; you can just use an online tool
    | implementing a browser-based converter.'''
