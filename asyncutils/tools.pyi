...
The default module name for a file extension not in this registry is just the extension itself. .jsonl files are parsed with :mod:`json` from the standard library.'''
