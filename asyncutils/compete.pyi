...
@overload
async def first_completed[T](*C: Awaitable[T], ret_exc: Literal[True], timeout: float|None=..., loop: AbstractEventLoop|None=...) -> BaseException|T|None: ...
@overload
async def first_completed[T](*C: Awaitable[T], ret_exc: Literal[False]=..., timeout: float|None=..., loop: AbstractEventLoop|None=...) -> T|None:
