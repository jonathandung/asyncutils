...
async def enhanced_staggered_race(cfs: SupportsIteration[Awaitable[Any]|SupportsIteration[Any]], delay: float|None=..., *, loop: AbstractEventLoop|None=...) -> tuple[Any, int|None, list[Exception|None]]: '''asyncio.staggered.staggered_race, but taking a larger variety of objects as the first argument using convert_to_coro_iter. See above.'''