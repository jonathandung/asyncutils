...
def take[T](it: SupportsIteration[T], n: int|None) -> AsyncGenerator[T]:
    ...
    .. tip::
      ...
      In particular, pass :const:`~asyncutils.constants.RAISE` as ``default`` to cause :class:`~asyncutils.exceptions.ItemsExhausted` to be thrown in the case that there
      aren't enough items.
