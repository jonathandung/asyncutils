...
class TimeAwareFuture[T](Future[T]):
    ...
    def __lt__(self, other: TimeAware, /) -> bool: ...
...
class AsyncCallbacksTask[T](Task[T], AsyncCallbacksFuture[T]): '''The task version of :class:`AsyncCallbacksFuture`.'''
...
class UniqueCallbacksTask[T](Task[T], UniqueCallbacksFuture[T]): '''Like :class:`AsyncCallbacksTask`, but disallow the same callback from being added twice. Removal is faster and more intuitive to use.'''
