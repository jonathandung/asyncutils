...
class AsyncCallbacksFuture[T](Future[T]):
    ...
    .. note:: To hook into the callbacks mechanism, subclassing :class:`_asyncio.Future` (the C-accelerated version) is impossible; i.e., this future is noticeably slow.'''
