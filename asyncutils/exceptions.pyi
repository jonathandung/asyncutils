...
class WarningToError:
    ...
    def __init__(self, /, *types: type[Warning]): '''Positional arguments represent warning types to convert to their corresponding error types if they are to occur within the context.'''
