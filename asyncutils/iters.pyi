...
async def aunzip(ait: SupportsIteration[tuple[Any, ...]], put_batch: int=..., fillvalue: Any=...) -> tuple[AUnzipConsumer[Any], ...]:
    '''Undo the effect of :class:`~builtins.zip`, :class:`itertools.zip_longest`, :func:`aziplongest` or :func:`azip`.
...
def batch[T](it: SupportsIteration[T], size: int, *, timeout: float|None=..., strict: bool=...) -> AsyncGenerator[list[T]]: ...
@overload
