...
def merge_async_iters[T](*I: SupportsIteration[T], reverse: bool=...) -> AsyncGenerator[T]: ...
...
@overload
def asideeffect[T](f: Callable[[list[T]], Any], it: SupportsIteration[T], /, *, size: int, before: Callable[[], Any]|None=..., after: Callable[[], Any]|None=...) -> AsyncGenerator[T]: ...
@overload
def asideeffect[T](f: Callable[[T], Any], it: SupportsIteration[T], /, *, size: None=..., before: Callable[[], Any]|None=..., after: Callable[[], Any]|None=...) -> AsyncGenerator[T]: ...
...
def afilter[T](f: Callable[[T], Any]|None, it: SupportsIteration[T]) -> AsyncGenerator[T]: ...
@overload
def amapif[T, R](f: Callable[[T], R], pred: Callable[[T], Any]|None, it: SupportsIteration[T], /, await_: Literal[False]=...) -> AsyncGenerator[R]: '''Essentially the restriction of `amultimapif` to one (async) iterable, which allows for more flexibility.'''
@overload
def amapif[T, R](f: Callable[[T], Awaitable[R]], pred: Callable[[T], Any]|None, it: SupportsIteration[T], /, await_: Literal[True]) -> AsyncGenerator[R]: ...
@overload
