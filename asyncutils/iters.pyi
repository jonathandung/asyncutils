...
def astarmap_withkwds[T](f: Callable[..., T], it: SupportsIteration[tuple[Iterable[Any], Mapping[str, Any]]], /) -> AsyncGenerator[T]: '''Like :func:`amap`, but the iterable should yield tuples of the form ``(args, kwargs)``, where `args` is an iterable of positional arguments and `kwargs` is a mapping of keyword arguments.'''
@overload
...
async def aunzip[T, R](ait: SupportsIteration[tuple[T|R, ...]], *, put_batch: int=..., fillvalue: R, maxqsize: int=...) -> tuple[AUnzipConsumer[T], ...]: ...
@overload
async def aunzip(ait: SupportsIteration[tuple[Any, ...]], *, put_batch: int=..., fillvalue: Any=..., maxqsize: int=...) -> tuple[AUnzipConsumer[Any], ...]:
