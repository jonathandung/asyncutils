...
@overload
async def aguessmax[T](it: SupportsIteration[T], estlen: int, *, key: Callable[[T], SupportsRichComparison]=..., default: T=..., finish_event: EventProtocol|None=..., reject_cb: None=...) -> T: ...
@overload
...
@overload
async def aguessmin[T](it: SupportsIteration[T], estlen: int, *, key: Callable[[T], SupportsRichComparison]=..., default: T=..., finish_event: EventProtocol|None=..., reject_cb: Callable[[T], object], await_cb: Literal[False]=...) -> T: ...
@overload
async def aguessmin[T](it: SupportsIteration[T], estlen: int, *, key: Callable[[T], SupportsRichComparison]=..., default: T=..., finish_event: EventProtocol|None=..., reject_cb: Callable[[T], Awaitable[object]], await_cb: Literal[True]) -> T: '''Like :func:`aguessmax`, but guesses the minimum item instead.'''
