...
def adropwhile[T](pred: Callable[[T], object], it: SupportsIteration[T]) -> AsyncGenerator[T]: '''Async version of :class:`itertools.dropwhile` that is not a class.'''
