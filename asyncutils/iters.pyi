...
@overload
def amap[R](f: Callable[..., R], /, *its: SupportsIteration[Any], await_: Literal[False]=..., strict: bool=...) -> AsyncGenerator[R]: '''Async version of :class:`map` that is not a class.'''
...
@overload
def acat[T](first: None=...) -> AsyncGenerator[T|None, T|None]: '''An async generator that yields the sent value, starting with `first`.'''
