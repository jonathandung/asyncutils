from ._internal.protocols import SupportsIteration, Exceptable, SupportsRichComparison, AsyncContextManager, SupportsSlicing, GenericSized
...
def asliced[T: SupportsSlicing](seq: T, n: int, strict: bool=...) -> AsyncGenerator[T, None]: ... # type: ignore[type-arg]
...
async def amatprod(it: SupportsIteration[Any], start: Any) -> Any: ...
...
@overload
async def afirsttrue[T](it: Iterable[T], default: T, pred: Callable[[T], Any]) -> T: ...
@overload
async def afirsttrue[T](it: Iterable[T], *, pred: Callable[[T], Any]) -> T: ...
@overload
async def afirsttrue[T](it: Iterable[T], default: T) -> T: ...
@overload
async def afirsttrue[T](it: Iterable[T]) -> T: ...
@overload
async def afirsttrue[T](it: AsyncIterable[T], default: T, pred: Callable[[T], Any]) -> T: ...
@overload
async def afirsttrue[T](it: AsyncIterable[T], *, pred: Callable[[T], Any]) -> T: ...
@overload
...
@overload
def areshape(mat: SupportsIteration[SupportsIteration[Any]], shape: int) -> AsyncGenerator[list[Any], None]: ...
@overload
