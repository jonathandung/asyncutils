...
def fmap_sequential[T, **P](fs: SupportsIteration[Callable[P, Awaitable[T]]], /, *a: P.args, **k: P.kwargs) -> AsyncGenerator[T, None]: '''Like `fmap`, but only call a function after the last completes and the result is gotten.'''
def fmap_parallel[T, **P](fs: SupportsIteration[Callable[P, Awaitable[T]]], /, *a: P.args, **k: P.kwargs) -> AsyncGenerator[T, None]: '''Like `fmap_sequential`, but starts background tasks for each call.'''
@overload
...
@overload
def asideeffect[T](f: Callable[[list[T]], Any], it: SupportsIteration[T], /, *, size: int, before: Callable[[], Any]|None=..., after: Callable[[], Any]|None=...) -> AsyncGenerator[T, None]: ...
@overload
def asideeffect[T](f: Callable[[T], Any], it: SupportsIteration[T], /, *, size: None=..., before: Callable[[], Any]|None=..., after: Callable[[], Any]|None=...) -> AsyncGenerator[T, None]: ...
def asliced[T: SupportsSlicing[Any]](seq: T, n: int, strict: bool=...) -> AsyncGenerator[T, None]: ...
...
def afilter[T](f: Callable[[T], Any]|None, it: SupportsIteration[T]) -> AsyncGenerator[T, None]: ...
@overload
def amapif[T, R](f: Callable[[T], R], pred: Callable[[T], Any]|None, it: SupportsIteration[T], /, await_: Literal[False]=...) -> AsyncGenerator[R, None]: '''Essentially the restriction of `amultimapif` to one (async) iterable, which allows for more flexibility.'''
@overload
def amapif[T, R](f: Callable[[T], Awaitable[R]], pred: Callable[[T], Any]|None, it: SupportsIteration[T], /, await_: Literal[True]) -> AsyncGenerator[R, None]: ...
@overload
def amultimapif[*Ts, R](f: Callable[[*Ts], R], pred: Callable[[tuple[*Ts]], bool], /, *its: SupportsIteration[Any], await_: Literal[False]=...) -> AsyncGenerator[R, None]: ...
@overload
def amultimapif[*Ts, R](f: Callable[[*Ts], Awaitable[R]], pred: Callable[[tuple[*Ts]], bool], /, *its: SupportsIteration[Any], await_: Literal[True]) -> AsyncGenerator[R, None]: ...
@overload
...
def aunique_everseen[T](it: SupportsIteration[T], key: Callable[[T], Any]=...) -> AsyncGenerator[T, None]: ...
def aunique_justseen[T](it: SupportsIteration[T], key: Callable[[T], Any]=...) -> AsyncGenerator[T, None]: ...
...
def aiterexcept[T](f: Callable[[], Awaitable[T]], exc: Exceptable, first: Callable[[], Awaitable[T]]=...) -> AsyncGenerator[T, None]: ...
...
def acollapse(it: SupportsIteration[Any], base_typ: tuple[type, ...]|type=..., levels: int|None=...) -> AsyncGenerator[Any, None]: ...
...
def aflattentensor(tensor: SupportsIteration[Any], base_typ: tuple[type, ...]|type=...) -> AsyncGenerator[Any, None]: ...
...
@overload
def areshape[T](mat: SupportsIteration[SupportsIteration[T]], shape: int) -> AsyncGenerator[list[T], None]: ...
@overload
def areshape(mat: SupportsIteration[Any], shape: SupportsIteration[int]) -> AsyncGenerator[list[Any], None]: ...
...
def adft(xarr: SupportsIteration[complex], /) -> AsyncGenerator[complex, None]: ...
def aidft(Xarr: SupportsIteration[complex], /) -> AsyncGenerator[complex, None]: ...
def apowers[X: (int, float, complex)](base: X, start: X=...) -> AsyncGenerator[X, None]: ...
def arunlengthencode[T](it: SupportsIteration[T]) -> AsyncGenerator[tuple[T, int], None]: ...
def arunlengthdecode[T](it: SupportsIteration[tuple[T, int]]) -> AsyncGenerator[T, None]: ...
@overload
...
def arunningmean[X: (int|float, complex)](it: SupportsIteration[X]) -> AsyncGenerator[X, None]: ...
@overload
def apowersetofsets[T](it: SupportsIteration[T], *, frozen: Literal[True]=...) -> AsyncGenerator[frozenset[T], None]: ...
@overload
def apowersetofsets[T](it: SupportsIteration[T], *, frozen: Literal[False]) -> AsyncGenerator[set[T], None]: ...
def aserialize[T](it: SupportsIteration[T]) -> AsyncGenerator[T, None]: ...