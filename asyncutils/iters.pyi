...
@overload
def azip[T](*I: SupportsIteration[T], strict: bool=...) -> AsyncGenerator[tuple[T, ...]]: '''Async version of :class:`zip` that is not a class.'''
@overload
...
@overload
def aproduct(i1: SupportsIteration[Any], i2: SupportsIteration[Any], i3: SupportsIteration[Any], i4: SupportsIteration[Any], i5: SupportsIteration[Any], /, *its: SupportsIteration[Any], repeat: int=...) -> AsyncGenerator[tuple[Any, ...]]: ...
@overload
def aproduct[T](*its: SupportsIteration[T], repeat: int=...) -> AsyncGenerator[tuple[T, ...]]: '''Async version of :class:`itertools.product` that is not a class.'''
@overload
...
@overload
def aziplongest[T](*its: SupportsIteration[T], fillvalue: T=...) -> AsyncGenerator[tuple[T, ...]]: '''Async version of :class:`itertools.zip_longest` that is not a class.'''
