N = type('Namespace', (dict,), dict(__getattr__=dict.__getitem__, __setattr__=dict.__setitem__, __delattr__=dict.__delitem__))(log_to='STDERR', executor='thread', Q=0, V=0, quiet=False, basic_repl=False, max_memerrs=3, load_all=False, seed=None)
