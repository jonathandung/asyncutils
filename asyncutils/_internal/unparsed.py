...
def r(p, e=None, /):
    ...
    with open(p, encoding='utf-8') as F:
        ...
        elif L == 'configparser': raise RuntimeError('asyncutils: cannot parse ini-like format due to type ambiguities; you should rewrite the configuration in TOML, which is the most similar to ini')
        else:
