...
def copy_and_clear[D: CanClearAndCopy](l: D) -> D: ... # type: ignore[type-arg]
...
class _LoopMixinBase:
    ...
    def make_multiple[T](self, C: Iterable[Coroutine[Any, Any, T]]) -> Generator[Task[T], None, None]: '''Return an iterator over instances of Task created for each coroutine in C, in that order.'''