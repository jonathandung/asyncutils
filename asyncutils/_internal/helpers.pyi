...
def subscriptable[T](cls: type[T], /) -> Subscriptable[T]: '''Add a :meth:`~object.__class_getitem__` method to the given class, raising :exc:`TypeError` if it is already present.'''
...
class Bag[T](dict[str, T]): # noqa: FURB189
