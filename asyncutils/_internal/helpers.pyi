...
def ismodule(o: object, /) -> TypeGuard[ModuleType]: '''Whether the given object is a module, or an :mod:`asyncutils`-internal submodule object.'''
...
def audit_fullname(f: object, /, remove_prefix: bool=...) -> None: '''Call :func:`sys.audit` on the fully-qualified name of the given object, as returned by :func:`fullname`.'''
...
class LoopMixinBase:
    '''The base class for :class:`~asyncutils.mixins.LoopMixin`.'''
    @property
