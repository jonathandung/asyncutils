...
class Module:
    ...
    def load(self) -> ModuleType: '''Load the submodule and replace the dummy with the actual submodule in :data:`submodules_map`. Triggered on attribute access or an explicit call.'''
    @property
