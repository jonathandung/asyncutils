...
def l(path: str|int, ext: str|None=..., /) -> dict[str, Any]: '''Load a config file from the given string path or file descriptor (in which case the file extension is should be passed but defaults to json), from which the file extension and thus appropriate parser is determined.'''