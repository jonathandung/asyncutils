...
mixins_all = 'EventualLoopMixin', 'LoopBoundMixin', 'LoopContextMixin', 'AwaitableMixin', 'AsyncContextMixin', 'LockMixin', 'LockWithOwnerMixin', 'EventMixin'
networking_all = 'LineProtocol', 'LFProtocol', 'CRLFProtocol', 'CRProtocol', 'SocketTransport'
