...
from .running_console import _get_ as _g, _request_write_load_all_ as _r
...
if config.loaded_all:
    ...
    s.update(config=config, exceptions=exceptions); del f, r
a += ('submodules_map',)
for _ in ('all submodules initialized', 'now loading: config', 'now loading: exceptions'): _l(_)
del sys, config, exceptions, _g, _r, _l, _d, _k, _v, _a, _f, _s, _u, d, _