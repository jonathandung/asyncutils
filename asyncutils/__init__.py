...
time_since_boot.__text_signature__, __hexversion__, console_preloaded_submodules = '()', int(__version__ := V('0.9.2')), (preloaded_submodules := frozenset(('config', 'constants', 'context', 'cli', 'exceptions', 'version'))).union(('base', 'console'))
del V, I, T, M