...
class LeakyBucket(AsyncContextMixin, EventualLoopMixin):
    ...
    def __enter__(self) -> Self: '''Begin draining the tokens.'''
    @overload
    def __exit__(self, exc_typ: ValidExcType, exc_val: BaseException, exc_tb: TracebackType|None, /) -> None: '''Stop draining the tokens.'''
    @overload
