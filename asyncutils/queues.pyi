...
@overload
def password_queue[T, R](password_put: R, *, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., puttyp: type[R]=..., init_items: SupportsIteration[T], strict: bool=...) -> P[R, T]: ...
@overload
def password_queue[T](*, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., init_items: SupportsIteration[T], strict: bool=...) -> P[Any, T]: ...
@overload
def password_queue[T, R](*, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., puttyp: type[R], init_items: SupportsIteration[T], strict: bool=...) -> P[R, T]: ...
@overload
def password_queue[T, R](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., gettyp: type[R]=..., init_items: SupportsIteration[T], strict: bool=...) -> G[R, T]: ...
@overload
def password_queue[T, R](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., gettyp: type[R], init_items: SupportsIteration[T], strict: bool=...) -> G[R, T]: ...
@overload
def password_queue[T](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., init_items: SupportsIteration[T], strict: bool=...) -> G[Any, T]: ...
@overload
def password_queue[T, R, V](password_put: V, password_get: R, maxsize: int=..., *, protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., gettyp: type[R]=..., puttyp: type[V]=..., init_items: SupportsIteration[T], strict: bool=...) -> B[R, V, T]: ...
@overload
def password_queue[T, R, V](password_put: V, *, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., gettyp: type[R], puttyp: type[V]=..., init_items: SupportsIteration[T], strict: bool=...) -> B[R, V, T]: ...
@overload
def password_queue[T, V](password_put: V, *, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., puttyp: type[V]=..., init_items: SupportsIteration[T], strict: bool=...) -> B[Any, V, T]: ...
@overload
def password_queue[T, R, V](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., gettyp: type[R]=..., puttyp: type[V], init_items: SupportsIteration[T], strict: bool=...) -> B[R, V, T]: ...
@overload
def password_queue[T, R](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., gettyp: type[R]=..., init_items: SupportsIteration[T], strict: bool=...) -> B[R, Any, T]: ...
@overload
def password_queue[T, R, V](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., gettyp: type[R], puttyp: type[V], init_items: SupportsIteration[T], strict: bool=...) -> B[R, V, T]: ...
@overload
def password_queue[T, R](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., gettyp: type[R], init_items: SupportsIteration[T], strict: bool=...) -> B[R, Any, T]: ...
@overload
def password_queue[T, V](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., puttyp: type[V], init_items: SupportsIteration[T], strict: bool=...) -> B[Any, V, T]: ...
@overload
def password_queue[T](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., init_items: SupportsIteration[T], strict: bool=...) -> B[Any, Any, T]: ...
@overload
def password_queue[R](password_put: R, *, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., puttyp: type[R]=..., strict: bool=...) -> P[R, Any]: ...
@overload
def password_queue[R](*, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., puttyp: type[R], strict: bool=...) -> P[R, Any]: ...
@overload
def password_queue(*, maxsize: int=..., protect_get: Literal[False]=..., protect_put: Literal[True]=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., strict: bool=...) -> P[Any, Any]: ...
@overload
def password_queue[R](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., gettyp: type[R]=..., strict: bool=...) -> G[R, Any]: ...
@overload
def password_queue[R](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., gettyp: type[R], strict: bool=...) -> G[R, Any]: ...
@overload
def password_queue(*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[False], can_change_get: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., strict: bool=...) -> G[Any, Any]: ...
@overload
def password_queue[R, V](password_put: V, password_get: R, maxsize: int=..., *, protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., gettyp: type[R]=..., puttyp: type[V]=..., strict: bool=...) -> B[R, V, Any]: ...
@overload
def password_queue[R, V](password_put: V, *, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., gettyp: type[R], puttyp: type[V]=..., strict: bool=...) -> B[R, V, Any]: ...
@overload
def password_queue[V](password_put: V, *, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., puttyp: type[V]=..., strict: bool=...) -> B[Any, V, Any]: ...
@overload
def password_queue[R, V](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., gettyp: type[R]=..., puttyp: type[V], strict: bool=...) -> B[R, V, Any]: ...
@overload
def password_queue[R](*, password_get: R, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., put_from: str=..., gettyp: type[R]=..., strict: bool=...) -> B[R, Any, Any]: ...
@overload
def password_queue[R, V](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., gettyp: type[R], puttyp: type[V], strict: bool=...) -> B[R, V, Any]: ...
@overload
def password_queue[R](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., gettyp: type[R], strict: bool=...) -> B[R, Any, Any]: ...
@overload
def password_queue[V](*, maxsize: int=..., protect_get: Literal[True], protect_put: Literal[True]=..., can_change_get: bool=..., can_change_put: bool=..., priority: bool=..., lifo: bool=..., get_from: str=..., put_from: str=..., puttyp: type[V], strict: bool=...) -> B[Any, V, Any]: ...
@overload
