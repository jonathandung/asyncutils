...
class AdvancedPool(LoopContextMixin):
    ...
    @overload
    def submit_nowait[T](self, f: Callable[..., T], *a: Any, _priority_: int, **k: Any) -> Future[T]: ...
    def revive(self) -> None: ...
    @overload
    async def submit[T, **P](self, f: Callable[P, T], *a: P.args, **k: P.kwargs) -> Future[T]: ...
    @overload
    async def submit[T](self, f: Callable[..., T], *a: Any, _priority_: int, **k: Any) -> Future[T]: ...
    @overload
    async def complete[T, **P](self, f: Callable[P, T], *a: P.args, **k: P.kwargs) -> T: ...
    @overload
    async def complete[T](self, f: Callable[..., T], *a: Any, _priority_: int, **k: Any) -> T: ...
    ...
    async def resize(self, min_workers: int, max_workers: int) -> None: ...
