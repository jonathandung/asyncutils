...
@overload
def every[T](interval: float, /, *, stop_when: Future[T], count_f: bool=..., verbose: bool=..., stop_on_exc: bool=..., loop: AbstractEventLoop|None=..., wait_first: bool=..., max_iterations: int|None=..., timer: Timer=..., supplied_args: Iterable[Any]=..., supplied_kwargs: Mapping[str, Any]=...) -> EveryRV[T]: ...
@overload
...
def every[T](interval: float, /, *, stop_when: Future[T], count_f: bool=..., verbose: bool=..., loop: AbstractEventLoop|None=..., stop_on_exc: bool=..., wait_first: bool=..., max_iterations: int|None=..., timer: Timer=..., supplied_args: Iterable[Any]=..., supplied_kwargs: Mapping[str, Any]=..., default: T) -> EveryRV[T]:
    ...
    '''
@overload
def everymethod(interval: float, /, *, count_f: bool=..., verbose: bool=..., stop_on_exc: bool=..., loop: AbstractEventLoop|None=..., wait_first: bool=..., max_iterations: int|None=..., timer: Timer=..., supplied_args: Iterable[Any]=..., supplied_kwargs: Mapping[str, Any]=...) -> EveryMethodRV[Any, Any]: ...
@overload
def everymethod[T, R](interval: float, /, *, stop_when_getter: Callable[[T], Future[R]], count_f: bool=..., verbose: bool=..., stop_on_exc: bool=..., loop: AbstractEventLoop|None=..., wait_first: bool=..., max_iterations: int|None=..., timer: Timer=..., supplied_args: Iterable[Any]=..., supplied_kwargs: Mapping[str, Any]=...) -> EveryMethodRV[R, T]: ...
@overload
...
def iterf[T](n: int, /) -> Callable[[Callable[[T], Awaitable[T]]], Callable[[T], CoroutineType[Any, Any, T]]]: '''Return a decorator that applies the decorated function ``n`` times to its argument.'''
...
class RateLimited[T, **P]:
    ...
    @overload
    def __new__(cls, calls: int, /, period: float, *, raise_: bool=..., timer: Timer=..., lock_impl: Callable[[], AsyncContextManager[Any]]=...) -> Callable[[Callable[P, Awaitable[T]]], Self]: ...
    @overload
    def __new__(cls, f: Callable[P, Awaitable[T]], /, calls: int, period: float, *, raise_: bool=..., timer: Timer=..., lock_impl: Callable[[], AsyncContextManager[Any]]=...) -> Self: '''Limit the rate of calls of a function ``f``, such that only ``calls`` calls within ``period`` seconds, as determined by ``timer``, are allowed.'''
