...
class MultiCountDownLatch[T: Hashable]:
    ...
    async def count_down(self, key: T, strict: bool=...) -> None: '''Decrement the count of the latch with the given key by one. If it reaches zero, wake up all waiters. If ``strict`` is ``True`` and the key doesn't exist, :exc:`KeyError` is raised.'''
