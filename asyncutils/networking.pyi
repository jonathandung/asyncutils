...
class LFProtocol(LineProtocol): '''Line Feed (LF) protocol for Unix-like systems.'''
class CRLFProtocol(LineProtocol): '''Carriage Return + Line Feed (CRLF) protocol for Windows.'''
