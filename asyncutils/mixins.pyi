...
from _collections_abc import Generator, Callable, Coroutine, AsyncGenerator
...
class AwaitableMixin[T: bool|None=None](metaclass=ABCMeta):
    __slots__ = ()
    def __await__(self) -> Generator[Any, None, T]: ...
    @abstractmethod
    async def wait(self) -> T: ...
class AsyncContextMixin[T=Any](metaclass=ABCMeta):
    @cached_property
