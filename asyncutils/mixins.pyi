...
class AsyncContextMixin[T](ABC):
    '''Derive :meth:`__aenter__` and :meth:`__aexit__` from :meth:`__enter__` (optional; returns self by default, but that cannot be typed accurately) and :meth:`__exit__` of subclasses.'''
