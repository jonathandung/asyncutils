...
class EventBus(LoopContextMixin):
    ...
    @overload
    def is_subscribed(self, subscriber: Callable[[Any], Awaitable], event_type: str) -> bool: ...
    @overload
    def is_subscribed(self, subscriber: Callable[[str, Any], Awaitable], event_type: _WildcardType) -> bool: ...
    @overload
    def is_subscribed(self, subscriber: Callable[..., Awaitable]) -> bool: ...
    @overload
