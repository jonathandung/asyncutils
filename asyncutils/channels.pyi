...
class EventBus(LoopContextMixin):
    ...
    def sync_start_publish(self, event_type: str, data: object=..., *, safe: bool=..., timeout: float|None=..., chaperone: Callable[[ExceptionGroup|Exception], object]|None=...) -> None: '''Begin a publication synchronously. Parameters are as in `publish`, below.'''
