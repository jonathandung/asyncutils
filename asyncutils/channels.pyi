...
class EventBus(LoopContextMixin):
    ...
    @overload
    def is_subscribed(self, callback: object, event_type: object) -> Literal[False]: '''Whether the callback is subscribed for the event type, or subscribed for any event type if event_type is not passed.'''
    @property
    ...
    @property
    def active_tasks(self) -> int: '''The number of callbacks at this moment.'''
    @property
