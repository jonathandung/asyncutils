...
class ResourceGuard(RuntimeError, AsyncContextMixin[None]):
    ...
    def __init__(self, action: str=..., rname: object=...):
        ...
        | ``rname`` is used in error messages to describe the resource by calling its :meth:`~object.__repr__`; if not passed, an index is
...
class UniqueResourceGuard(ResourceGuard):
    ...
    def __new__(cls, /, *a: object, **k: object) -> NoReturn: '''Use the :meth:`guard` class method instead.'''
    @classmethod
