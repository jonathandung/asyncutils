...
class Bulkhead(LoopContextMixin):
    ...
    @property
    def available_qslots(self) -> float: '''The number of available slots in the task queue. Gives an integer, unless the queue is unbounded, in which case :data:`math.inf` is returned.'''
    @property
