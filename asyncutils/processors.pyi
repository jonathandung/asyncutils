...
class Bulkhead(LoopContextMixin):
    ...
    @property
    def available_qslots(self) -> float: '''The number of available slots in the task queue. Usually an integer, but `float('inf')` if the queue is unbounded.'''
    @property
    ...
    async def shutdown(self, timeout: float|None=...) -> list[Coroutine[Any, Any, Any]]: '''Shut down the bulkhead.'''