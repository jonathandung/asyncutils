...
if [ "$READTHEDOCS" = "True" ]; then
	m=".. note:: Generated by scripts/generate.sh in the $READTHEDOCS_VERSION Read the Docs build at $t UTC."
else
	m=".. note:: Preview generated by scripts/generate.sh at $t UTC. DO NOT COMMIT."
fi
